/*************************
 * Original url: http://wiki.unity3d.com/index.php/Particle_Spiral_Effect
 * Github url: https://github.com/wolfreak99/UnifyGithub/blob/master/Scripts/Effects/GeneralPurposeEffectScripts/Particle_Spiral_Effect.cs
...
namespace UnifyGithub.Effects.GeneralPurposeEffectScripts
{
    ...
    1.2 How to Use 
    1.3 Samples 
    2 C# - ParticleSpiralEffect.cs 
    
    Description This script spawns "spiral" particle effects, such as might be used for portals, whirlpools, galaxies, etc. The script can be adjusted to spawn any number of particle systems for repeating spiral effects. This can be useful, for example, when the particle effect is parented to a moving object. 
    Features Set the number of arms of the spiral and the particle density of each arm 
    ...
    How to Use Assign this script to a transform or game object at the location where the spiral effect will be centered. The spiral will be generated in the plane specified by the script transform's red axis (right, x) and blue axis (forward, z)and centered around the green axis (up, y). 
    ...
    Samples Here are just a few of the many kinds of effects you can achieve. 
     
    
    
    C# - ParticleSpiralEffect.csusing UnityEngine; 
