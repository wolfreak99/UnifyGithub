...
Features Set the fade out time (lifetime) when the trail is done emitting 
...
One-Time Use This trail renderer is designed to be a one-time use component. There are several reasons for this, based on the way it is designed for optimization. When emitting is set to false, the trail renderer will stop adding new segments and fade out. The fade out time is set to the lifetime. 
Image  
C# - TrailArc.csusing UnityEngine;
