...
namespace UnifyGithub.General.MessagingSystems
{
    ...
    Description I didn't like having a UnityScript file in my otherwise CSharp script folder, so I ported it to C#. 
    ...
    CSharp - NotificationCenter.cs //    NotificationCenter is used for handling messages between GameObjects.
