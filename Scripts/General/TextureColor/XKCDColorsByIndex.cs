...
Usage Example //reference the script in whatever way you choose
xkcdColorReader cr;
 
//call the generation function with a number between 0-948
cr.GenerateColor(420);
 
//apply the color to whatever object you have
MyMonster.material.color = cr.color.cColor;
 
//save the color name if you want. you should. the names are hilarious.
MyMonsterStats.ColorName = cr.color.sName;xkcdColorReader.csusing UnityEngine;
...
public class xkcdColorReader : MonoBehaviour 
{
    ...
    //the last generated color. colors generated by GenerateColor(int) calls go here for you to access.
    public vColor color;
...
}xkcdColors.txtcloudy blue	#acc2d9	
...
blue	#0343df	
green	#15b01a	
purple	#7e1e9cHistory 13 July 2016 - Release 
}
