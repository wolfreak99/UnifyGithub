/*************************
 * Original url: http://wiki.unity3d.com/index.php/MeshSubdivision
 * Github url: https://github.com/wolfreak99/UnifyGithub/blob/master/Scripts/General/MeshHelpers/MeshSubdivision.cs
...
namespace UnifyGithub.General.MeshHelpers
{
    ...
    1 Description 
    1.1 Author and idea: 
    1.2 uv and normal support: 
    2 Problem 
    3 Usage 
    4 subdivision.js 
    
    DescriptionAuthor and idea: realm_1 
    uv and normal support: BigMisterB 
    This script subdivide a mesh by using edge and center subdivision. 
    ProblemIf you want to deform a mesh, for eg. when a bullet hit it, and you have only two triangles per side (cube) then it won't work. Because you need more vertices. With this script you can easily add more. Also if you want to add some effect to your mesh and you have not enough vertices you can use this script. 
    Try it out by using a cube instead of a sphere in the procedural unity3d examples. (http://unity3d.com/support/resources/example-projects/procedural-examples.html) During the gameplay you subdivide the mesh and you will see that the effect will work better. 
    UsageAttach this script to a GameObject with a mesh and a material. Press "1" for edge subdivision and "2" for center subdivision, to restore the mesh press "x". 
    subdivision.js//var material : Material;
