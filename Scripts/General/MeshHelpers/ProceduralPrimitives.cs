...
namespace UnifyGithub.General.MeshHelpers
{
    ...
    C# - Plane // You can change that line to provide another MeshFilter
    ...
    C# - Box // You can change that line to provide another MeshFilter
    MeshFilter filter = gameObject.AddComponent< MeshFilter >();
    Mesh mesh = filter.mesh;
    mesh.Clear();
    ...
    C# - Cone Note that cylinders (bottomRadius == topRadius) and pyramids (4 sides, topRadius == 0) are types of cones, and can be created with this script. 
    MeshFilter filter = gameObject.AddComponent<MeshFilter>();
    Mesh mesh = filter.mesh;
    mesh.Clear();
    ...
    C# - Tube MeshFilter filter = gameObject.AddComponent<MeshFilter>();
    Mesh mesh = filter.mesh;
    mesh.Clear();
    ...
    C# - Torus MeshFilter filter = gameObject.AddComponent< MeshFilter >();
    Mesh mesh = filter.mesh;
    mesh.Clear();
    ...
    C# - Sphere Regular sphere. Source : http://stackoverflow.com/questions/4081898/procedurally-generate-a-sphere-mesh 
    MeshFilter filter = gameObject.AddComponent< MeshFilter >();
    Mesh mesh = filter.mesh;
    mesh.Clear();
    ...
    C# - IcoSphere This is a sphere without poles. Source : http://blog.andreaskahler.com/2009/06/creating-icosphere-mesh-in-code.html 
    ...
    }Tips Dealing with all thoses vertices and indexes can give you a headache before you know it. To see things clearly, you can create a TextMesh, set it up properly (small characters, anchor at middle-center) and save it as a prefab. Then, instantiate one at each vertices to see those indexes, like so : 
