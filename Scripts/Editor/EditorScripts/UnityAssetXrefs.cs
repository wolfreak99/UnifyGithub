/*************************
 * Original url: http://wiki.unity3d.com/index.php/UnityAssetXrefs
 * Github url: https://github.com/wolfreak99/UnifyGithub/blob/master/Scripts/Editor/EditorScripts/UnityAssetXrefs.cs
 * File based on original modification date of: 28 April 2014, at 23:32. 
 *
...
{
    DescriptionThese MenuItems on the Assets menu allow you to list and automatically select all of the reverse dependencies of the currently selected Asset. It also includes a "Select All Missing refs" command which will list and select all Assets which have a "Missing" object reference somewhere in them. 
    ...
    UnityAssetXrefs.csusing UnityEngine;
    using UnityEditor;
    ...
    public class UnityAssetXrefs {
    	...
    	/* This is still useful, because it finds places where you have dragged the item onto scene objects.
    	   Unity's built-in feature "Find References in Scene." does not find those uses. - MM */
