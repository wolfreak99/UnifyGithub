// Original url: http://wiki.unity3d.com/index.php/Custom_terrain_lightmap_For_Windows_Based_Systems
// Github url: https://github.com/wolfreak99/UnifyGithub/blob/Master/Scripts/Editor/EditorScripts/Custom_terrain_lightmap_For_Windows_Based_Systems.cs
...
Description Generate a lightmap for your terrain that has beautiful soft tree shadows and maybe looks a little uglier because I never finished the aliasing on hard shadows!! 
...
JavaScript - customTerrainLightmap.js import System.IO;
 
class  customTerrainLightmap extends  ScriptableWizard
{
    var size = 512;
    ...
    {
        ScriptableWizard.DisplayWizard("Custom Lightmap", customTerrainLightmap, "Bake"); 
    }
    ...
    function OnWizardUpdate ()
    {
        ...
        if(!light || light.type != LightType.Directional) helpString = "custom light map wizard for windows _ by : Sobhan Bahrami!";
