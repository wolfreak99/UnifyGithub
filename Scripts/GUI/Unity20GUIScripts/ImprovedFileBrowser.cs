// Original url: http://wiki.unity3d.com/index.php/ImprovedFileBrowser
...
}Fix: Root Directory By Pablo Bollansée (The Oddler) - Unity 3.4.0f5 - Windows 7(x64) 
protected void ReadDirectoryContents()
{
if (m_currentDirectory == "/")
{
...
Usage Here we have a file path that can be assigned using the file browser. It uses the filter so that only text files are selectable. 
using UnityEngine;
