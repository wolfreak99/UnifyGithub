...
namespace UnifyGithub.GUI.GraphicalUserInterfaceScripts
{
    ...
    Setup Simply add the script to an object you can reference, and add a single line of code to the script about a third the way down (where the large comment is) to run your open/load code. 
    Then in what ever script you want to access it from, use GetComponent (found here: [1]) to get a variable "Browser" that you can use later. 
    Usage Simply call: Browser.OpenFile( The_Path_To_Your_MainSaves_Folder ); to allow the user to open any file in the directory you specify. 
