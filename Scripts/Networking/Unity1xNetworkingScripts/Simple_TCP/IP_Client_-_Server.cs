...
{
TCP/IP Client - Server Basics Simple TCP/IP Client DLL Code - Client code and instructions for the DLL written in C# 
Simple TCP/IP Server Code - Server Code 
Simple TCP/IP Unity Code - Unity Script Code 
}
